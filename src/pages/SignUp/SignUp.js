  ...
  const playerSignUp = async () => {
    if (validation()) {
      ...
      try {
        ...
        if (p["iscreated"] !== "Created") setValid(p["iscreated"]);
        else {
          navigate("/Login");
        }
      } catch (error) {
  ...
  return (
    <div className="LoginSignPage">
      ...
      <div>
        ...
        {localStorage.getItem("Role") === "Admin" ? (
          <button className="SaveButton" onClick={AdminSignUp}>
            Save
          </button>
        ) : (
          <div>
            ...
            {isPlayer ? (
              <div>
                ...
                <button className="SaveButton" onClick={playerSignUp}>
                  Save
                </button>
              </div>
            ) : null}
            {isCreator ? (
              <div>
                ...
                <button className="SaveButton" onClick={CreatorSignUp}>
                  Save
                </button>
              </div>
            ) : null}
            ...
            <div className="LoginSignAs">
              <button className="LoginSignAsRole" onClick={CreatorHan}>
                Creator
              </button>
              <button className="LoginSignAsRole" onClick={PlayerHan}>
                Player
              </button>
            </div>
